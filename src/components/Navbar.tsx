      ...
      <div className="bg-[#0B1F33] text-slate-300 text-xs py-2.5 px-4 border-b border-[#102A43]">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-4 text-slate-300 font-medium">
            <a href="tel:+27718398978" className="hidden lg:inline text-slate-300 hover:text-white transition-colors">{companyConfig.phonePlaceholder}</a>
            <a href="tel:+27718398978" className="text-[#168C8C] hover:text-[#19a5a5] font-semibold flex items-center gap-1 transition-colors">
